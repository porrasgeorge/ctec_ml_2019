...
5. Realice predicciones utilizando el conjunto de pruebas y evalue el resultado con la métrica MSE.
  ...
  Se puede observar que para los datos de prueba, en la mayoria de los casos las predicciones se aproximan al valor real, idealmente deberian estar lo mas cercano posible a la recta en morado. 
...
Utilizando diversas variables y distintos procesados a las mismas, se obtienen metricas muy semejantes, como se puede observar a continuacion.
