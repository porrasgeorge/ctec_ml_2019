...
```{r}
datos <- read.csv("temp_5571830814335439232.csv", header = T)
...
#ggplot(datos, aes(x = Edad)) + gg_formato + gg_tipo
...
#ggplot(datos, aes(x = Canton)) + gg_formato + gg_tipo
...
t1 <- table(datos$Rol,datos$Tipo_Lesion)
plot(t1)
t2 <- as_tibble(t1)
length(t2)
t2
