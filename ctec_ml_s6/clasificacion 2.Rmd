...
predicciones_redClass = ifelse(predicciones_red$net.result >= 0.5, T, F)
...
predicciones_LR <- predict(predicciones_red, 
                           newdata = cosevi_test)


neuralnet::prediction(predicciones_red, c(cosevi_test$HayHerido))
